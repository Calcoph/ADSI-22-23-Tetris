...
public class CompartirResultados extends JFrame {
	...
	public CompartirResultados() {
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			...
			{
				Gestor.getGestor().publicarResultados("Twitter");
			}
		});
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				Gestor.getGestor().publicarResultados("Facebook");
			}
		});
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) 
			{
				Gestor.getGestor().publicarResultados("Instagram");
			}
		});
